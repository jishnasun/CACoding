...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
            ViewManagerModel viewManagerModel, LoginViewModel loginViewModel, SignupViewModel signupViewModel,
             ...
             ClearUserDataAccessInterface clearUserDAO) {

        try {
            SignupController signupController = createUserSignupUseCase(viewManagerModel, signupViewModel, loginViewModel, userDataAccessObject);
            ClearController clearController = createClearUsersUseCase(clearUserDAO, clearViewModel);
    ...
    private static ClearController createClearUsersUseCase(ClearUserDataAccessInterface userDataAccessObject,
                                                           ClearViewModel clearViewModel) throws IOException {
